...
INSERT INTO users (id, username, password_hash, nickname, bio) VALUES
  (1, 'alice', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llCIBiRKnD/DSC', 'Alice', '测试用户 Alice'),
  (2, 'bob', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llCIBiRKnD/DSC', 'Bob', '测试用户 Bob'),
  (3, 'charlie', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llCIBiRKnD/DSC', 'Charlie', '测试用户 Charlie');
